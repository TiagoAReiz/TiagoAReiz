...
Software Engineer on the banking team at **Superlógica**, building generative AI and RAG products that run in production with customers. Backend in Java & Python, from APIs to Kubernetes on AWS.

- 🔎 RAG pipelines over **3,000+ documents**, cutting analysis time from **8 min to 1**
- ⚡ Serverless architecture (AWS Lambda) that took AI PoC publishing from **~1 week to 1 day** — 300+ PoCs, 50+ used by customers
- 🧱 Outside work: event-driven architecture, clean/hexagonal architecture and testing with Java & Spring Boot
...
|---|---|
| [**FastDocs**](https://github.com/TiagoAReiz/fastdocs) | Multi-tenant RAG microservice — LangGraph agent with retry/reformulation, pgvector, Celery, transactional outbox, SSE |
